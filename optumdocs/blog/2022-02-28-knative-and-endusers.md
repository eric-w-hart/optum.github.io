---
title: Knative from the lens of an end user
author: Murugappan Sevugan Chetty
author_title: Senior Principal Engineer
author_url: https://itsmurugappan.github.io
author_image_url: https://github.com/itsmurugappan.png
tags: [Engineering, Knative, serverless, faas, oss, enduser, steering]
...
![](./images/enduser-platform-architecture.png)

![](./images/enduser-enterprise-integration.png)
